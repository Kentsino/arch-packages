...
sudo pacman -S firefox kitty neovim ufw apparmor nvidia amd-ucode cuda htop flameshot xorg libx11 libxinerama libxft dunst nitrogen wget lf feh ttf-jetbrains-mono patch
